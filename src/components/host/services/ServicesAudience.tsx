// src/components/host/services/ServicesAudience.tsx
// Ref image 2 & 7: foto wajah orang asli, fan style, tengah terbesar
// Urutan: man glasses, woman short hair, woman center (biggest), man curly, woman dark skin

// Foto wajah orang dari Airbnb (portrait photos)
const avatarFaces = [
  {
    ...
    size: 72,
    fallback: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=240&h=240&fit=crop&crop=face",
  },
  {
    ...
    size: 90,
    fallback: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=240&h=240&fit=crop&crop=face",
  },
  {
    ...
    size: 112,
    fallback: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=240&h=240&fit=crop&crop=face",
  },
  {
    // Man curly hair
    src: "https://a0.muscache.com/im/pictures/user/User-354476882/original/b9fbd3b1-4dc5-40e1-a7dd-45cd38ba77ca.jpg?im_w=240",
    size: 90,
    fallback: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=240&h=240&fit=crop&crop=face",
  },
  {
    ...
    size: 72,
    fallback: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=240&h=240&fit=crop&crop=face",
  },
];

function AvatarCircle({ src, fallback, size }: { src: string; fallback: string; size: number }) {
  return (
    <img
      src={src}
      alt="Guest"
      className="rounded-full object-cover object-top border-[3px] border-white shadow-md shrink-0"
    ...
    <section className="py-24 bg-white">
      <div className="max-w-[1760px] mx-auto px-6 md:px-10 lg:px-20">
        <div className="text-center">
              ...
              {avatarFaces.map((av, i) => (
                ...
                >
                  <img
                    ...
                    onError={(e) => { (e.target as HTMLImageElement).src = av.fallback; }}
                    loading="lazy"
                  />
                </div>
              ))}
          ...
          {/* Stat 1 */}
          <p className="text-[40px] md:text-[52px] font-bold text-hof leading-none">390 juta tamu</p>
          ...
          {/* Stat 2 */}
          <p className="text-[40px] md:text-[52px] font-bold text-hof leading-none">$81 miliar USD</p>
          <p className="text-[15px] md:text-[17px] text-foggy mt-2">dibelanjakan di Airbnb pada tahun 2024</p>
