...
type FooterSection = "dukungan" | "menjadi_tuan_rumah" | "airbnb";
const footerLinks: Record<FooterSection, string[]> = {
  dukungan: [
    "Pusat Bantuan",
    ...
    <footer className="bg-[#F7F7F7] border-t border-gray-200">
      <div className="max-w-[1760px] mx-auto px-6 md:px-10 lg:px-20 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-sm font-semibold text-[#222222] mb-4">Dukungan</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-[#222222] mb-4">Menjadi Tuan Rumah</h3>
            <ul className="space-y-3">
              {footerLinks.menjadi_tuan_rumah.map((link) => (
                <li key={link}>
                  <a href="#" className="text-sm text-[#222222] hover:underline">
                    {link}
                  </a>
          ...
          <div>
            <h3 className="text-sm font-semibold text-[#222222] mb-4">Airbnb</h3>
            <ul className="space-y-3">
      ...
      <div className="border-t border-gray-200">
        <div className="max-w-[1760px] mx-auto px-6 md:px-10 lg:px-20 py-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 text-sm text-[#222222]">
            ...
            <div className="flex items-center gap-4">
              <button className="flex items-center gap-2 text-sm font-semibold text-[#222222] hover:underline">
